...
public class LeaderboardController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "CONFLICT: (1) Leaderboard name cannot be blank; (2) The leaderboard start date cannot be posterior to the leaderboard end date. (3) The game assigned to the leaderboard must have at least one rule with the same achievement assigned to the leaderboard.", content = @Content)
    })
